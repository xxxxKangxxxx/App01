      ...
      <View style={{ flex: 1 }}>
        {Array.from({ length: mirrorShelves }, (_, idx) => (
          <React.Fragment key={idx}>
            ...
            >
              <Text style={{ fontSize: 9, color: '#c8d4de' }}>{idx + 1}</Text>
            </View>
            ...
            {Array.from({ length: zone.shelves }, (_, idx) => {
              ...
              return (
                <React.Fragment key={shelfNum}>
                  ...
                  >
                    <Text style={{ fontSize: 8, color: '#9ca3af', fontWeight: '600', marginBottom: 1 }}>
                      {shelfNum}
                    </Text>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 1 }}>
                      {visibleEmoji.length === 0 ? (
                        <Text style={{ fontSize: 10, color: '#d1d9e0' }}>-</Text>
                      ) : (
                      ...
                      {extra > 0 && (
                        <Text style={{ fontSize: 8, color: '#9ca3af', alignSelf: 'flex-end' }}>
                          +{extra}
                        </Text>
                      )}
                    </View>
